...
#pragma comment(linker, "/export:uncompress2=zlib0.uncompress2")
...
#pragma comment(linker,                                                        \
                "/export:deflateSetDictionary=zlib0.deflateSetDictionary")
...
#pragma comment(linker, "/export:deflatePending=zlib0.deflatePending")
...
#pragma comment(linker,                                                        \
                "/export:inflateSetDictionary=zlib0.inflateSetDictionary")
#pragma comment(linker,                                                        \
                "/export:inflateGetDictionary=zlib0.inflateGetDictionary")
...
#pragma comment(linker, "/export:gzfread=zlib0.gzfread")
#pragma comment(linker, "/export:gzwrite=zlib0.gzwrite")
#pragma comment(linker, "/export:gzfwrite=zlib0.gzfwrite")
...
#pragma comment(linker, "/export:gzgetc_=zlib0.gzgetc_")
